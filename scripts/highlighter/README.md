...
- **Works across pages:** Highlights the [**Campus Connect Tracker List**](https://central.wordcamp.org/wp-admin/edit.php?post_type=wordcamp&post_status=all&type=campusconnect) and [**Campus Connect Details**](https://central.wordcamp.org/wp-admin/index.php?page=wordcamp-reports&report=campus-connect-details) report on WordCamp Central.

## Notes
- On the trackers list, filters only apply to the current page. Consider increasing the number in Screen Options (I use 30).
- Also, while it does work with WordCamps, the "Starting Soon" timeline works best for Campus Connects
- Because this is meant to visually parse a page full of different statuses, it currently does not do anything on single-status views.

## Installation

1. Install [Tampermonkey](https://www.tampermonkey.net/) for your browser.  
2. Click the raw link to the script:  
   [**Event Status Highlighter.user.js**](https://raw.githubusercontent.com/WordPress/Community-Team/trunk/scripts/highlighter/statushighlighter.user.js)  
3. Tampermonkey will prompt you to install the script.  
4. Visit the [**tracker list at WordCamp Central**](https://central.wordcamp.org/wp-admin/) or the [**Campus Connect report page**](https://central.wordcamp.org/wp-admin/index.php?page=wordcamp-reports&report=campus-connect-details) — highlights will appear automatically.

## Development

- Copied from https://github.com/supernovia/Scripts/tree/master/org. This script is currently **velda-vibe-coded** with some manual edits, but inspired by similar idea [Ethan](https://github.com/EthanChristensen01) helped me with many years ago.
